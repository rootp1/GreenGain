  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        console.log("Final base64 string length:", base64.length);
        console.log("Base64 preview:", base64.slice(0, 50));
    ...
    <div className="card">
      ...
      {imageUrl && (
        <div className="image-preview">
          <img src={imageUrl} alt="Uploaded" className="uploaded-tree-image" />
        </div>
      )}
      ...
      {species && !showPopover && (
        <button className="popybutton" onClick={() => setShowPopover(true)}>
